...
echo "<td>" . $row->ID . "</td>";
echo "<td>" . $row->nume . "</td>";
echo "<td><a href='Modificare_sponsori.php?id=" . $row->ID . "'>Modificare</a></td>";
echo "<td><a href='Stergere_sponsori.php?id=" .$row->ID . "'>Stergere</a></td>";
echo "</tr>";
}
echo "</table>";
}
...
$mysqli->close();
?>
<a href="Inserare_sponsori.php">Adaugarea unei noi inregistrari</a>
</body>
</html>
